...
import {
  selectFilteredAutoReplies,
  selectSearchText,
  setAutoRepliesSearchText,
} from '../../store/autoRepliesSlice';

const AutoRepliesHeader = (props) => {
      ...
      <div className="flex flex-col w-full sm:w-auto sm:flex-row space-y-16 sm:space-y-0 flex-1 items-center justify-end space-x-8">
        ...
        >
          ...
          <Input
            ...
            onChange={(ev) => dispatch(setAutoRepliesSearchText(ev))}
          />
        </Paper>
        <motion.div
...
export default AutoRepliesHeader;
