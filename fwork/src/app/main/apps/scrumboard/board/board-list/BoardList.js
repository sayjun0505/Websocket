...
import BoardCardCompactView from '../board-card/BoardCardCompactView';
        ...
        <div ref={provided.innerRef} {...provided.draggableProps}>
          <StyledCard
            ...
            className={clsx(
              ...
              'w-[80vw] sm:w-320 mx-8 max-h-full flex flex-col rounded-xl border'
            )}
            square
          >
            <BoardListHeader
                ...
                {(_provided) => (
                  ...
                  >
                    {cardIds.map((cardId, index) => {
                      ...
                      if (isCompactView) {
                        return <BoardCard key={cardId} cardId={cardId} index={index} list={list} />;
                      }
                      return (
                        <BoardCardCompactView
                          key={cardId}
                          cardId={cardId}
                          index={index}
                          list={list}
